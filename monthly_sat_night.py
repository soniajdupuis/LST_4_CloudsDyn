...
2008–2020 MetOp-A AVHRR NIGHT observations

Outputs:
--------
1. combined_monthly_NIGHT_2008_2020.nc
...
for year in YEARS:
    ...
    pattern = (
        ...
        f"LST_AVMEA_All_Arctic__v.11.0__*NIGHT.nc"
    )
...
combined_outfile = os.path.join(
    OUTPUT_DIR,
    "combined_monthly_NIGHT_2008_2020_coarse.nc"
)
